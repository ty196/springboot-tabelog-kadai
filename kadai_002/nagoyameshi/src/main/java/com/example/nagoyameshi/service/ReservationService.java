...
private final ReservationRepository reservationRepository;        
    ...
    public boolean isTwoHoursApartFromOthers(LocalDateTime reservationDateTime, User user) {
        ...
        List<Reservation> reservations = reservationRepository.findByUserAndReservedDatetimeBetween(user, twoHoursBefore, twoHoursAfter);
    ...
    public int getRemainingSeats(LocalDateTime reservationDateTime, Restaurant restaurant) {
        ...
        List<Reservation> reservations = reservationRepository.findByRestaurantAndReservedDatetimeBetween(restaurant, twoHoursBefore, twoHoursAfter);
